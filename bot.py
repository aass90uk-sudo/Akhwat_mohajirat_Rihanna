...
async def auto_post_job(context: ContextTypes.DEFAULT_TYPE):
    ...
    prompt = (
        "اكتب موعظة إيمانية حماسية بليغة ومؤثرة جداً للأمة الإسلامية وشباب بلدان المغرب الإسلامي».. اجعلها أربعة أسطر. "
        "ركز على توجيه الإخوة والأخوات الموحدين في مغرب الإسلام بتربية جيل لا يرضون دون شرع الله في مغرب الإسلام، فضل الجهاد والرباط».. اجعلها خمسة اسطر، "
        "اختتم المنشور بالدعاء لأهلنا الموحدين في ارض الجزائر وكافة بلاد مغرب الإسلام». اجعلها أربعة اسطر."
    )
