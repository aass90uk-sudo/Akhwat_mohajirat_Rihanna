...
async def auto_post_job(context: ContextTypes.DEFAULT_TYPE):
    ...
    prompt = (
        ...
        "ركز على نصائح النساء والرجال في مغرب الإسلام تربية جيل لا يرضون دون شرع الله في مغرب الإسلام، فضل الجهاد والرباط».. اجعلها خمسة اسطر، "
        "اختتم المنشور بالدعاء لأهلنا الموحدين في ارض الجزائر». اجعلها أربعة اسطر."
    )
