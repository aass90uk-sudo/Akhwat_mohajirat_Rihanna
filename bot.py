...
FOOTER_TEXT = "\n\n☝🏻⚔️🖤 صدقة جارية للأخت «أم عقيدة وحمزة» غفر الله لها "
...
async def auto_post_job(context: ContextTypes.DEFAULT_TYPE):
    ...
    prompt = (
        "اكتب موعظة إيمانية حماسية بليغة ومؤثرة جداً للأمة الإسلامية وشباب بلدان المغرب الإسلامي».. لا تتجاوز ثلاثة أسطر. "
        "ركز على توجيه الإخوة والأخوات الموحدين في مغرب الإسلام بتربية جيل لا يرضون دون شرع الله في مغرب الإسلام، فضل الجهاد والرباط».. لا يتجاوز ثلاثة اسطر، "
        "اختتم المنشور بالدعاء لأهلنا الموحدين في ارض الجزائر وكافة بلاد مغرب الإسلام». لا يتجاوز ثلاثة اسطر."
    )
...
async def handle_channel_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    system_role = (
        ...
        "تعليقك يعمّق المعنى ويزيد الفائدة ويحرّك القلوب. اجعله قصيراً لا يتجاوز اربعة أو خمسة."
    )
